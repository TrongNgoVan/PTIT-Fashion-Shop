                        ...
                        <div class="row" style="margin: 10px;">
                            ...
                            <div class="col-12 mb-4">
                                <div class="product__item d-flex align-items-center p-3 border rounded shadow-sm">
                                    <div class="product__item__pic me-4" style="margin: 10px; width: 150px; height: 150px; background-size: cover; background-position: center; background-image: url('<?= "http://localhost/PTIT_SHOP/quantri/" . $anh_arr[0] ?>'); position: relative;">
